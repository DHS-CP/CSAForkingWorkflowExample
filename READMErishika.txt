Team Names: Melody Wang, Rishika Thorat, Darion Phan, Kevin Park

Name of Workflow: Forking Workflow
...
The primary difference between forking and the basic workflow is the fact that forking has The primary difference between forking and the basic workflow is the fact that forking has a different method on how they get shared. When sharing a forking workflow you have to pull it into the developer’s local repository. With the basic workflow, it gets pushed to the main, shared repository. 

Link to your Git example repository: 
https://github.com/rishikathorat/CSAForkingWorkflowExample
